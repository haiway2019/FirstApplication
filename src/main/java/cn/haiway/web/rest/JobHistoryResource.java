...
import cn.haiway.web.rest.errors.BadRequestAlertException;
import cn.haiway.web.rest.util.HeaderUtil;
import cn.haiway.web.rest.util.PaginationUtil;
...
public class JobHistoryResource {
    ...
    private static final String ENTITY_NAME = "firstApplicationJobHistory";
    ...
    public ResponseEntity<JobHistory> getJobHistory(@PathVariable String id) {
