...
class JobHistoryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the JobHistory entity")
        ...
        .repeat(2) {
            ...
            .get("/firstapplication/api/job-histories")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new jobHistory")
            .post("/firstapplication/api/job-histories")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/firstapplication${new_jobHistory_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created jobHistory")
            .delete("/firstapplication${new_jobHistory_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
